...
export default function HeroParallax() {
  ...
  return (
    ...
    >
      {/* ✅ Background image */}
      {/* ✅ Mobile background (xxs to sm) */}
      <div
        className="absolute inset-0 z-0 bg-cover bg-center md:hidden "
        style={{ backgroundImage: 'url("/images/bg-hero-mobile.jpg")' }}
      />
      ...
      <div className="relative z-30 text-center max-w-3xl text-white space-y-6 mt-32">
        <h1
          ref={headingRef}
          className="text-3xl sm:text-6xl font-extrabold leading-tight tracking-tight font-heading uppercase italic bold"
        >
          Athrolis <br />

...
export default function HowItWorksSection() {
  return (
    <section
      id="how-it-works"
      className="relative bg-gradient-to-b from-[#333932] via-[#363b35] to-[#242923] py-16 px-6 sm:px-10"
    >
      ...
      <div className=" max-w-7xl mx-auto">
        {/* Titre global */}
        <div className=" grid grid-cols-1 md:grid-cols-2 items-center gap-4 mb-10">
          ...
          <h2 className="md:absolute mt-40 md:mt-0 md:top-15 md:right-28  p-6 text-3xl sm:text-6xl font-extrabold leading-tight tracking-tight font-heading uppercase italic bold font-outline text-transparent text-center md:text-right max-w-3xl">
            YOUR PLAN
          </h2>
        </div>

        {/* Étapes */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10 md:mt-40">
          <StepCard
            step={1}
